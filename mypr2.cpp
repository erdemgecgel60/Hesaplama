   ...
   case 4: 
      ...
      case 5: 
           ...
           if ((yesorno == "Evet") || (yesorno == "Yes"))
           {
             ...
             cout << "Sifreyi Makine mi yoksa siz mi olusturacaksiniz : " ;

             cin >> machineorme;

             if (machineorme == "Machine")
             {
              ...
              cout << "Yeni Sifreniz : " << randomid << endl;
               
             }

             else if (machineorme == "Me")
             {
                
                cout << "Olusturdugunuz Sifreyi Giriniz : " ;
          ...
          {
            cout << "Sifre Degistirilemedi." << endl;
          }
